...
aux1 = imopen(binario_1, strel("sphere", n));
aux3 = imopen(binario_3, strel("sphere", n));
aux5 = imopen(binario_5, strel("sphere", n));
aux7 = imopen(binario_7, strel("sphere", n));
aux9 = imopen(binario_9, strel("sphere", n));
